EPICS::Application.routes.draw do
  ...
  get "orders/donate"
  get "orders/donate_index"
  post "orders/donate_index"
  get "orders/select_donation_item"
  post "orders/select_donation_item"
  post "orders/remove_product_from_donate_cart"
  ######### orders end ########
